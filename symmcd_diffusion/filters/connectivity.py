...
# Core vocabulary (12 types): H=0,C=1,N=2,O=3,F=4,S=5,B=6,Cu=7,Zn=8,Co=9,Q=10,R=11
# Q = connector attachment point, R = functional group attachment point
CORE_Q_IDX = 10
CORE_R_IDX = 11
CONNECTOR_ATOM_TYPES = [CORE_Q_IDX, CORE_R_IDX]
