"""
run.py — Main MAPPO training runner for COF construction (6-agent).

Orchestrates:
  1. Environment creation (CustomEnvironment from env.py)
  2. Data collection (batch_size episodes)
  3. RND exploration updates
  4. Predictor-based reward computation (N2/O2 via PMTransformer)
  5. MAPPO training via mappo_mpe.MAPPO_MPE
  6. Checkpoint saving

Usage:
    python run.py  # uses default args from argparse
"""
