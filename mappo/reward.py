"""
reward.py — Reward functions and RND exploration for COF MARL.

Components:
  - RND: Random Network Distillation for intrinsic exploration rewards
  - middle_reward(): step-wise reward during BB construction
  - final_reward(): terminal reward based on COF assembly success
  - predictor integration for N2/O2 property-based rewards

Dependencies: cof_predictor, pycofbuilder, combine_substructures
"""
