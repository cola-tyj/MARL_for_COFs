"""
replay_buffer.py — Experience replay buffer for MAPPO training.

Stores transitions as numpy arrays:
  obs_n:     (batch_size, episode_limit, N, obs_dim)
  s:         (batch_size, episode_limit, state_dim)
  v_n:       (batch_size, episode_limit + 1, N)
  a_n:       (batch_size, episode_limit, N)
  r_n:       (batch_size, episode_limit, N)
  done_n:    (batch_size, episode_limit, N)

Provides get_training_data() to return torch tensors for PPO updates.
"""
