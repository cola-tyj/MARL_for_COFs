...
Parses agent-generated BB strings, extracts symmetry types, topology,
and builds the final COF via pycofbuilder Framework.

Used by both reward computation and COF evaluation pipelines.
"""
