"""
xyz.py — 2D XYZ coordinate generation for molecular structures.

Converts SMILES/InChI to 2D atom coordinates using RDKit.
Used by reward.py for molecular structure validation.
"""
