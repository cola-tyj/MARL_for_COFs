"""
combine_substructures.py — RDKit-based molecular substructure assembly.

Combines building block fragments into complete molecular graphs:
  - add_R_groups(): attach functional groups to attachment points
  - get_substructures(): parse agent-generated string into mol fragments
  - combined(): assemble all substructures into final molecule

Used by reward.py and cof_fromname.py for structure validation.
"""
