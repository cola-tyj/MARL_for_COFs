...
Embedding_Layer: token embedding for building block vocabulary
TransformerEncoder: self-attention encoder for molecular sequences

Pre-trained weights stored in model/ directory.
Used by env.py for encoding COF construction states.
"""
